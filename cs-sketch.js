...
class FSM {
            ...
            switch(g_bot.cDirection)
            {
                case Cardinal.North:  
                    ...
                    { // Convert dir to x,y deltas: dir = clock w 0=Up,2=Rt,4=Dn,6=Left.
                        case Actions.TurnLeft : {  dx = -1; g_bot.cDirection = Cardinal.West; break; } // left, W WORKS
                ...
                case Cardinal.South: 
                    switch (this.direction)
                    { // Convert dir to x,y deltas: dir = clock w 0=Up,2=Rt,4=Dn,6=Left.
                        case Actions.TurnLeft : {  dx = 1; g_bot.cDirection = Cardinal.East; break; } // left, W WORKS
                        case Actions.TurnRight : { dx = -1; g_bot.cDirection = Cardinal.West; break; } // right, E.
                    }
                break;
                case Cardinal.West: 
                    switch (this.direction)
                    { // Convert dir to x,y deltas : dir = clock w 0=Up,2=Rt,4=Dn,6=Left.
                        ...
                        case Actions.TurnLeft : {  dy = 1; g_bot.cDirection = Cardinal.South; break; } // left, W WORKS
                ...
                case Cardinal.East:
                    switch (this.direction)
                    { // Convert dir to x,y deltas: dir = clock w 0=Up,2=Rt,4=Dn,6=Left.
                        case Actions.TurnLeft : {  dy = -1; g_bot.cDirection = Cardinal.North; break; } // left, W WORKS
    ...
    SetCounter(colorIndex)
    {
        ...
        //console.log("Set Counter to " + this.counter);
    }
...
function move_bot() // Move the bot in new direction & update color.
{
    bot_steps++; // count the steps the bot is taking
    console.log("Steps: " + bot_steps);
    if (max_2000) { // check if bot should only run 2000 steps
        if (bot_steps == 2000) {
            g_stop = !g_stop;
            console.log(g_stop);
        }
...
window.onload = function() { // Draw a counter on the HTML page that goes up to 2000 steps.
    ctr = document.getElementById("counter"); // get element from index.html

    function incrementCounter() {
        ctr.innerHTML = bot_steps;
